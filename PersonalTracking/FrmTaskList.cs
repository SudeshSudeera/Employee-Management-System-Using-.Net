    ...
    public partial class FrmTaskList : Form
    {
        ...
        private void FrmTaskList_Load(object sender, EventArgs e)
        {
            ...
            if (!UserStatic.isAdmin)
            {
                ...
                btnClose.Location = new Point(504, 20);
                btnApprove.Location = new Point(366, 20);
                pnlForAdmin.Hide();
        ...
        {
            DialogResult result = MessageBox.Show("Are you sure to delete task", "Warning", MessageBoxButtons.YesNo);
